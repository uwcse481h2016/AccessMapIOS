...
class ViewController: UIViewController, UISearchBarDelegate, MGLMapViewDelegate, UITextFieldDelegate {
...
//        self.view.addSubview(label)
        ...
        start = drawTextField(30, y:20, width:300, height:40)
        end = drawTextField(30, y:60, width:300, height:40)
        drawButton(275, y: 620, width: 100, height: 50, title: "route", actionSelector : "routeAction:")
        drawButton(0, y: 620, width: 100, height: 50, title: "here", actionSelector : "locationAction:")
            ...
            if let placemark = placemarks?.first {
                ...
                geocoder.geocodeAddressString(endAddress, completionHandler: {(placemarks, error) -> Void in
                    ...
                    if let placemark = placemarks?.first {
                        ...
                        self.map.setCenterCoordinate(center, zoomLevel: log(maxC) + 4, animated: true)
